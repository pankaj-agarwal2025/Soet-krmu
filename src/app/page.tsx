        ...
        <section className="bg-gradient-to-r from-blue-800 to-blue-900 text-white py-16">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-xl mb-6">Welcome to the SOET Portal — a centralized showcase of all live and deployed projects developed by students of the School of Engineering and Technology (SOET).
              </p>
        ...
        <section id="projects" className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-blue-900 mb-2">Projects Developed by Students</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Discover innovative projects created by our talented students showcasing their skills and creativity.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>They way to connect with the campus</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    Campus Connect is an AI-driven platform that streamlines placement processes, enhances student employability, automates CDC tasks, and features a resume analyzer based on ATS scores.
                  </p>
                  ...
                  /> */}
                          <Image src="/khushnam.jpeg" alt='Khushnam Chauhan' width={124} height={124} />
                          <AvatarFallback className="text-lg">KC</AvatarFallback>
                        </Avatar>
                      </div>
                      ...
                      <div className="mb-2 ml-5">
                        <Avatar className="w-24 h-24 border-2 border-blue-200">
                          <AvatarImage
                            ...
                            className=""
                          />
                          {/* <Image src="/apoorva.jpeg" alt='Khushnam Chauhan' width={120} height={120} /> */}
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>This project help to interact between alumni and faculty</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    An intelligent system that leverages modern web technologies to manage alumni data, enabling institutions to maintain strong alumni relations and enhance engagement efficiently.
                  </p>
                    ...
                    <div className="text-center">
                      <div className="mb-2">
                        <Avatar className="w-24 h-24 border-2 border-green-200">
                          ...
                          <AvatarFallback className="text-lg">RR</AvatarFallback>
                        </Avatar>
                      </div>
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>The Way to the campuse for a new world</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    our project is about solving the problem faced by the counselling department in conducting the interview of the candidates as per their selected time slot and which was earlier done manually.
                  </p>
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>This project help to manage faculty teaching hours</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    A web-based portal for managing faculty teaching hours with real-time Google Sheets synchronization, enabling efficient, automated tracking, updates, and two-way data collaboration.
                  </p>
                      ...
                      <div className="mb-2 ml-5">
                        <Avatar className="w-24 h-24 border-2 border-orange-200">
                          <AvatarImage
                            ...
                            className="object-cover"
                          />
                          <AvatarFallback className="text-lg">DTR</AvatarFallback>
                        </Avatar>
                      </div>
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>This platform work securly manage students Internship</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    A centralized, faculty-login-based portal developed for KRMU to securely manage student internships and projects with document handling and report generation features.
                  </p>
              ...
              <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  ...
                  <CardDescription>This portal contains all the projects of SOET</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-6">
                    This portal serves as a dynamic platform to highlight the innovation, creativity, and technical skills of our student developers. Each project listed here is not just a concept, but a fully functional deployment.
              ...
              <Card className="border-t-4 border-t-green-600 hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-center">
                      <ArrowRight size={16} className="mr-2 text-green-600" />
                      Automatically updates the changed data                    </li>
                    <li className="flex items-center">
                      <ArrowRight size={16} className="mr-2 text-green-600" />
                    ...
                    <li className="flex items-center">
                      <ArrowRight size={16} className="mr-2 text-green-600" />
                      Finalize the teaching hours of the faculty                    </li>
                  </ul>
                </CardContent>
                <CardFooter>
                  <Link href="https://cdc.soet-krmu.com/">
